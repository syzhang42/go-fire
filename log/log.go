...
func (l *Logger) levelOutput(pc uintptr, calldepth int, lv string, appendOutput func([]byte) []byte) error {
	if l.isDiscard.Load() {
		return nil
	}
...
func (l *Logger) output(pc uintptr, calldepth int, appendOutput func([]byte) []byte) error {
	return l.levelOutput(pc, calldepth, levelNone, appendOutput)
}
